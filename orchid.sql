...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 31 2021 г., 20:20
...
CREATE TABLE `categories` (
  ...
  `name_rus` varchar(50) CHARACTER SET utf8 COLLATE utf8 NOT NULL COMMENT 'название категории'
...
CREATE TABLE `goods` (
  ...
  `options` text CHARACTER SET utf8 COLLATE utf8 NOT NULL COMMENT 'описание в виде {"название характеристики": "описание характеристики", "название": "описание"}',
